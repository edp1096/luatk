...
# installed.
TCL_PREFIX='/home/runneradmin/dist'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/runneradmin/dist'
...
# build directory.
TCL_BUILD_LIB_SPEC='-LD:/a/tcltk/tcltk/tcl/win -ltcl90'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/runneradmin/dist/lib -ltcl90'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/runneradmin/dist/include'
...
# compiled.
TCL_SRC_DIR='D:/a/tcltk/tcltk/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/runneradmin/dist\lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-LD:/a/tcltk/tcltk/tcl/win -ltclstub'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/runneradmin/dist/lib -ltclstub'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='D:/a/tcltk/tcltk/tcl/win/libtclstub.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/runneradmin/dist/lib/libtclstub.a'
